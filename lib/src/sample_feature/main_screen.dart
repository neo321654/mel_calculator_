...
//  final AdaptiveThemeMode? savedThemeMode;
  ...
  //const MainScreen({Key? key, this.savedThemeMode}) : super(key: key);
      ...
      children: <Widget>[
        ...
        ListTile(
          trailing: IconButton(
            ...
            onPressed: () {
              updateSettings("CategoryADalay", categoryADelay);
        ...
        ListTile(
          trailing: IconButton(
            icon: Icon(Icons.save),
            onPressed: () {
              updateSettings("CategoryBDalay", categoryBDelay);
            },
          ),
          title: TextFormField(
        ...
        ListTile(
          trailing: IconButton(
            icon: Icon(Icons.save),
            onPressed: () {
              updateSettings("CategoryCDalay", categoryCDelay);
            },
          ),
          title: TextFormField(
            onChanged: (text) {
        ...
        ListTile(
          trailing: IconButton(
            icon: Icon(Icons.save),
            onPressed: () {
              updateSettings("CategoryDDalay", categoryDDelay);
            },
          ),
          title: TextFormField(
            onChanged: (text) {
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Category D ($categoryCDelay days)",
                ),
              ],
            ),
          ),
